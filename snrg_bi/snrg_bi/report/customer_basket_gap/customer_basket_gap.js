frappe.query_reports["Customer Basket Gap"] = {
  filters: [
    ...
    { fieldname: "has_item_code", label: __("Buys Item"), fieldtype: "Link", options: "Item", depends_on: "eval:doc.has_target_type == 'Item'" },
    { fieldname: "has_item_group", label: __("Buys Item Group"), fieldtype: "Link", options: "Item Group", depends_on: "eval:doc.has_target_type == 'Item Group'" },
    { fieldname: "missing_target_type", label: __("Missing Target Type"), fieldtype: "Select", options: "Item\nItem Group", default: "Item", reqd: 1 },
    { fieldname: "missing_item_code", label: __("Does Not Buy Item"), fieldtype: "Link", options: "Item", depends_on: "eval:doc.missing_target_type == 'Item'" },
    { fieldname: "missing_item_group", label: __("Does Not Buy Item Group"), fieldtype: "Link", options: "Item Group", depends_on: "eval:doc.missing_target_type == 'Item Group'" },
